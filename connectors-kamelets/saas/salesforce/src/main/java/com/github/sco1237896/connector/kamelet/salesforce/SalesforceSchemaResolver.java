package com.github.sco1237896.connector.kamelet.salesforce;
...
public class SalesforceSchemaResolver implements Processor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        exchange.setProperty("X-Content-Schema", objectSchema);
        exchange.setProperty("X-Content-Schema-Type", "json");
    }
