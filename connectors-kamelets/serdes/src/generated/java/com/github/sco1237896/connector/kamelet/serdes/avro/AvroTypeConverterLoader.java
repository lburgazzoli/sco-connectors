...
public final class AvroTypeConverterLoader implements TypeConverterLoader, CamelContextAware {
    ...
    private void registerConverters(TypeConverterRegistry registry) {
        addTypeConverter(registry, com.fasterxml.jackson.dataformat.avro.AvroSchema.class, java.io.InputStream.class, false,
            (type, exchange, value) -> com.github.sco1237896.connector.kamelet.serdes.avro.AvroTypeConverter.toAvroSchema((java.io.InputStream) value));
        addTypeConverter(registry, com.fasterxml.jackson.dataformat.avro.AvroSchema.class, java.lang.String.class, false,
            (type, exchange, value) -> com.github.sco1237896.connector.kamelet.serdes.avro.AvroTypeConverter.toAvroSchema((java.lang.String) value));
        addTypeConverter(registry, java.lang.String.class, com.fasterxml.jackson.dataformat.avro.AvroSchema.class, false,
            (type, exchange, value) -> com.github.sco1237896.connector.kamelet.serdes.avro.AvroTypeConverter.toString((com.fasterxml.jackson.dataformat.avro.AvroSchema) value));
        addTypeConverter(registry, org.apache.avro.Schema.class, java.io.InputStream.class, false,
            (type, exchange, value) -> com.github.sco1237896.connector.kamelet.serdes.avro.AvroTypeConverter.toSchema((java.io.InputStream) value));
        addTypeConverter(registry, org.apache.avro.Schema.class, java.lang.String.class, false,
            (type, exchange, value) -> com.github.sco1237896.connector.kamelet.serdes.avro.AvroTypeConverter.toSchema((java.lang.String) value));
    }
