...
class ConnectorIT extends KafkaConnectorSpec {
    ...
    def "azure-eventhubs sink"() {
        setup:
            ...
            def cnt = connectorContainer('azure_eventhubs_sink_v1.json', [
                'kafka_topic' : topic,
        ...
        when:
        KafkaConnectorSpec.kafka.send(topic, payload, headers)
    ...
    def "azure-eventhubs source"() {
        setup:
            ...
            def cnt = connectorContainer('azure_eventhubs_source_v1.json', [
                    'kafka_topic' : topic,
                    'kafka_bootstrap_servers': KafkaConnectorSpec.kafka.outsideBootstrapServers,
                    'azure_eventhub_name': eventhubName,
                    'azure_namespace_name': namespaceName,
