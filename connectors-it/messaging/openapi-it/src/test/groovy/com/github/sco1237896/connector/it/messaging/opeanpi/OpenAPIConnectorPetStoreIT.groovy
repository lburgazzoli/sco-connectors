...
import com.github.sco1237896.connector.it.support.WaitStrategies
...
class OpenAPIConnectorPetStoreIT extends KafkaConnectorSpec {
    ...
    def setupSpec() {
        ...
        petStore.withNetwork(KafkaConnectorSpec.network)
    ...
    def "openapi petstore sink"() {
        setup:
            ...
            def cnt = connectorContainer('rest_openapi_sink_v1.json', [
                'kafka_topic' : topic,
