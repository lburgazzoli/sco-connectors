package com.github.sco1237896.connector.it.{{connector.group}}.{{connector.type}}
...
class ConnectorContainerIT extends SimpleConnectorSpec {
    ...
    def "container image exposes health and metrics"(String definition) {
        ...
        where:
            definition << [
                '{{connector.type}}_{{connector.version}}_source.json',
                '{{connector.type}}_{{connector.version}}_sink.json'
            ]
    }
}
