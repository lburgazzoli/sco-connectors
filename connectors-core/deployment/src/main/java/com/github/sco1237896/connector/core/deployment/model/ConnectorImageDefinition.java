...
public class ConnectorImageDefinition extends CustomResource<ConnectorImageDefinitionSpec, ConnectorImageDefinitionStatus> {

    public ConnectorImageDefinition() {
        super();
    ...
    @Override
    protected ConnectorImageDefinitionSpec initSpec() {
        return new ConnectorImageDefinitionSpec();
    }
}
